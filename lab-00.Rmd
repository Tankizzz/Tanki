...
```{r setup-tibble}
team_data <- tibble(
  name = c("Yankun", "Hani", "Hezhen Wang", 
           "XiChen", "member 4"),
  github_username = c("Shuangyk", "haniman26", "HEZHENWANG", 
                      "XiChen0612", "username 4"), 
  colour = c("powderblue", "white", "blue", 
             "purple", "colour 4"),
  hobby = c("gaming", "solving puzzles", "football", 
            "jogging", "hobby 4"),
  favourite_number = c(5, 6, 6, 6, NA)
  )
